            ...
            if (type == TYPE_ACTIVE) {
                ...
                if (total > 0) {
                    ...
                    if (speed > 0) {
                        ...
                        remainingText = res.getString(R.string.download_remaining, ReflectUtils.formatDuration(remainingMillis));
                    }
    ...
    public void dumpSpeeds() {
        synchronized (mDownloadSpeed) {
            for (int i = 0; i < mDownloadSpeed.size(); i++) {
                ...
                Log.d(Constants.TAG, "Download " + id + " speed " + mDownloadSpeed.valueAt(i) + "bps, "
                        + delta + "ms ago");
            }
        }
    }
