...
class StopRequestException extends Exception {
    ...
    public static StopRequestException throwUnhandledHttpError(int code, String message)
        ...
        if (code >= 400 && code < 600) {
            ...
            throw new StopRequestException(Downloads.Impl.STATUS_UNHANDLED_REDIRECT, error);
        } else {
            throw new StopRequestException(Downloads.Impl.STATUS_UNHANDLED_HTTP_CODE, error);
        }
    }
}
