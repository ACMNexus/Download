...
public class DownloadStorageProvider extends DocumentsProvider {
    ...
    public boolean onCreate() {
        ...
        ReflectUtils.setAccessAllDownloads(mDm, true);
        return true;
    }
    ...
    public String createDocument(String docId, String mimeType, String displayName)
        ...
        try {
            ...
            return Long.toString(mDm.addCompletedDownload(file.getName(), file.getName(), false, mimeType, file.getAbsolutePath(), 0L, true));
        } finally {
    ...
    public Cursor queryChildDocuments(String docId, String[] projection, String sortOrder)
        ...
        Cursor cursor = null;
        try {
            cursor = mDm.query(ReflectUtils.setOnlyIncludeVisibleInDownloadsUi(new Query(), true)
    ...
    public Cursor queryRecentDocuments(String rootId, String[] projection)
        ...
        Cursor cursor = null;
        try {
            cursor = mDm.query(ReflectUtils.setOnlyIncludeVisibleInDownloadsUi(new Query(), true).setFilterByStatus(DownloadManager.STATUS_SUCCESSFUL));
            copyNotificationUri(result, cursor);
    ...
    public ParcelFileDescriptor openDocument(String docId, String mode, CancellationSignal signal)
        ...
        try {
            ...
            return resolver.openFileDescriptor(ReflectUtils.getDownloadUri(id, mDm), mode, signal);
        } finally {
            Binder.restoreCallingIdentity(token);
        }
    }
