...
class RealSystemFacade implements SystemFacade {
    ...
    public NetworkInfo getActiveNetworkInfo(int uid) {
        ...
        final NetworkInfo activeInfo = ReflectUtils.getActiveNetworkInfoForUid(connectivity, uid);
    ...
    public boolean isNetworkRoaming() {
        ...
        TelephonyManager telephonyManager = (TelephonyManager) mContext.getSystemService(Context.TELECOM_SERVICE);
