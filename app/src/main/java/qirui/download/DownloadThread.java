...
public class DownloadThread implements Runnable {
    ...
    private void runInternal() {
        ...
        try {
            ...
            //TODO this is a system api, normal application can't use the api
//            TrafficStats.setThreadStatsUid(mInfo.mUid);
            ...
            if (finalStatus == Downloads.Impl.STATUS_WAITING_TO_RETRY) {
            ...
            if (isStatusRetryable(finalStatus)) {
                ...
                if (numFailed < Constants.MAX_RETRIES) {
                    ...
                    if (info != null && info.getType() == state.mNetworkType
                        ...
                        finalStatus = Downloads.Impl.STATUS_WAITING_TO_RETRY;
                    } else {
            ...
            if (finalStatus == Downloads.Impl.STATUS_SUCCESS) {
                TrafficStats.incrementOperationCount(1);
            }

            TrafficStats.clearThreadStatsTag();
            //TODO this is system api, outer application can't use
            ...
            try {
                ...
                switch (responseCode) {
                    case HTTP_OK:
                        if (state.mContinuingDownload) {
                            throw new StopRequestException(
                                    Downloads.Impl.STATUS_CANNOT_RESUME, "Expected partial, but received OK");
                        }
                    ...
                    case HTTP_PARTIAL:
                        if (!state.mContinuingDownload) {
                            throw new StopRequestException(
                                    Downloads.Impl.STATUS_CANNOT_RESUME, "Expected OK, but received partial");
                        }
                        transferData(state, conn);
                        return;
                    ...
                    case HTTP_REQUESTED_RANGE_NOT_SATISFIABLE:
                        throw new StopRequestException(
                                Downloads.Impl.STATUS_CANNOT_RESUME, "Requested range not satisfiable");
